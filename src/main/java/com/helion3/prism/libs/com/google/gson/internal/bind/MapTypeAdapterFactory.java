...
import com.helion3.prism.libs.com.google.gson.internal.JsonReaderInternalAccess;
...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
   ...
   public TypeAdapter create(Gson gson, TypeToken typeToken) {
      ...
      if (!Map.class.isAssignableFrom(rawType)) {
         ...
         TypeAdapter result = new Adapter(gson, keyAndValueTypes[0], keyAdapter, keyAndValueTypes[1], valueAdapter, constructor);
         return result;
      }
   }
   ...
   private final class Adapter extends TypeAdapter {
      ...
      public void write(JsonWriter out, Map map) throws IOException {
         if (map == null) {
            ...
            while(i$x.hasNext()) {
               Map.Entry entryx = (Map.Entry)i$x.next();
